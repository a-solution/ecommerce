      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
                <input type='text' name="text" cols="60" rows="1" placeholder="<?php echo $entry_text; ?>" id="input-text" class="form-control" value="<?php echo $text; ?>"/>
              <?php if ($error_text) { ?>
            ...
            <label class="col-sm-2 control-label" for="input-answer-text">Answer Text</label>
            <div class="col-sm-10">
              <textarea name="answer_text" cols="60" rows="8" placeholder="answer_text" id="input-answer-text" class="form-control"><?php echo $answer_text; ?></textarea>
            </div>
