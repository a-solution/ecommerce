<?php
class ControllerCheckoutGuestCheckout extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/guest_checkout.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/checkout/guest_checkout.tpl', $data);
		} else {
			return $this->load->view('default/template/checkout/guest.tpl', $data);
		}
	}
