<?php
class ControllerCommonContentIntro extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/content_intro.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/content_intro.tpl', $data);
		} else {
			return $this->load->view('default/template/common/content_intro.tpl', $data);
		}
	}
}