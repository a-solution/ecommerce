<div id="checkout-option-form" class="row checkout-option">
  ...
  <div class="col-sm-6">
    ...
    <div class="form-group">
      <label class="control-label hidden-xs" for="input-email"><?php echo $entry_email; ?></label>
      <input type="text" name="email" value="" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" />
    </div>
    <div class="form-group">
      <label class="control-label hidden-xs" for="input-password"><?php echo $entry_password; ?></label>
